...
Vagrant.configure('2') do |config|
  ...
  # config.vm.provision :file, source: '~/bogdan/ssh/gitlab_ssh/.ssh/id_rsa', destination: '~/.ssh/id_rsa'
  # config.vm.provision :file, source: '~/bogdan/ssh/gitlab_ssh/.ssh/id_rsa.pub', destination: '~/.ssh/id_rsa.pub'
